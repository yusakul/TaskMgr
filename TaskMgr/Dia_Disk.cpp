...
IMPLEMENT_DYNAMIC(CDia_Disk, CDialogEx)

CDia_Disk::CDia_Disk(CWnd* pParent /*=NULL*/)
...
void CDia_Disk::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDia_Disk, CDialogEx)
	ON_WM_TIMER()
END_MESSAGE_MAP()
...
BOOL CDia_Disk::OnInitDialog()
{
	...
	m_progress_D.SetPos(100 - Rate_C);
	m_progress_E.SetPos(100 - Rate_C);
	m_progress_F.SetPos(100 - Rate_C);
	m_progress_G.SetPos(100 - Rate_C);
	m_progress_H.SetPos(100 - Rate_C);
...
void CDia_Disk::OnTimer(UINT_PTR nIDEvent)
{
