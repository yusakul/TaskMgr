...
IMPLEMENT_DYNAMIC(CDia_Thread, CDialogEx)

CDia_Thread::CDia_Thread(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_DIALOG_THREAD, pParent)
{

}

CDia_Thread::~CDia_Thread()
{
}

void CDia_Thread::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CDia_Thread, CDialogEx)
	ON_WM_CLOSE()
	ON_NOTIFY(NM_RCLICK, IDC_LIST_Thread, &CDia_Thread::OnRclickListThread)
END_MESSAGE_MAP()
...
BOOL CDia_Thread::ListProcessThreads(DWORD dwOwnerPID)
{
...
void CDia_Thread::OnRclickListThread(NMHDR *pNMHDR, LRESULT *pResult)
{
	...
	*pResult = 0;
	...
	switch (Select)
	{
	case ID_MOUSERCLICK_32780:	//挂起线程
	{
	...
	break;
	case ID_MOUSERCLICK_32781:	//恢复线程
	{
	...
	break;
	case ID_MOUSERCLICK_32782:	//结束线程
	{
